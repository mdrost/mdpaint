#ifndef MDP_VIPSRECTANGLETOOL_H
#define MDP_VIPSRECTANGLETOOL_H
...
class mdpVipsRectangleTool final : public mdpTool
{
public:

    explicit mdpVipsRectangleTool(mdpVipsModel& vipsModel, mdpHistory& history);

    ~mdpVipsRectangleTool() override;
