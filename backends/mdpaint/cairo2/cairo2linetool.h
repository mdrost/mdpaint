#ifndef MDP_CAIRO2LINETOOL_H
#define MDP_CAIRO2LINETOOL_H
...
class mdpCairo2LineTool final : public mdpTool
{
public:

    explicit mdpCairo2LineTool(mdpCairo2Model& cairoModel, mdpHistory& history);

    ~mdpCairo2LineTool() override;
