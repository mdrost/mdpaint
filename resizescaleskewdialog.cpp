...
// public
mdpResizeScaleSkewDialog::mdpResizeScaleSkewDialog(int currentWidth, int currentHeight) :
    m_resizeScaleSkewData({0, 0, currentWidth, currentHeight, true, 0.0, 0.0})
{
    ...
    QSpinBox* skewHorizontalSpinBox = new mdpSpinBox(this);
...
// public virtual
mdpResizeScaleSkewDialog::~mdpResizeScaleSkewDialog() /* override */
{
}

// public
mdpResizeScaleSkewData mdpResizeScaleSkewDialog::getResizeScaleSkewData() const
{
