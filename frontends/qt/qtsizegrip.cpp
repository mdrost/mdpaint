...
// public
mdpQtSizeGrip::mdpQtSizeGrip(Type type, QWidget* resizable, QWidget* parent) :
    QWidget(parent),
    m_type(type),
...
// public virtual
mdpQtSizeGrip::~mdpQtSizeGrip() /* override */
{
}

// public
mdpQtSizeGrip::Type mdpQtSizeGrip::type() const
{
    return m_type;
}

// public virtual
QSize mdpQtSizeGrip::sizeHint() const /* override */
{
    return QSize(5, 5);
}

// protected virtual
void mdpQtSizeGrip::mousePressEvent(QMouseEvent* e) /* override */
{
...
// protected virtual
void mdpQtSizeGrip::mouseReleaseEvent(QMouseEvent* e) /* override */
{
    if (e->button() == Qt::LeftButton && m_resizing) { // TODO: is checking m_resizing necessary?
        m_resizing = false;
...
// protected virtual
void mdpQtSizeGrip::mouseMoveEvent(QMouseEvent* e) /* override */
{
    if (m_resizing) {
...
// protected virtual
void mdpQtSizeGrip::paintEvent(QPaintEvent* e) /* override */
{
